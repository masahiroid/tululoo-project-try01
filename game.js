...
__sprite_init__(this, spr_player, 20, 40, 10, 20, 'Box', 10, 0, 20, 0, 40, ['img/spr_player_0.png']);
...
__sprite_init__(this, spr_piece, 11, 11, 0, 0, 'Circle', 5, 0, 11, 0, 11, ['img/spr_piece_0.png']);
}; var spr_piece = new __spr_piece();

function __spr_cloud() { 
__sprite_init__(this, spr_cloud, 180, 60, 0, 0, 'Box', 90, 0, 180, 0, 60, ['img/spr_cloud_0.png']);
}; var spr_cloud = new __spr_cloud();

function __sprite_35() { 
__sprite_init__(this, sprite_35, 20, 40, 10, 20, 'Box', 10, 0, 20, 0, 40, ['img/sprite_35_0.png']);
}; var sprite_35 = new __sprite_35();

function __new_game() { 
__sprite_init__(this, new_game, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/new_game_0.png']);
}; var new_game = new __new_game();

function __sprite_118() { 
__sprite_init__(this, sprite_118, 40, 40, 20, 20, 'Circle', 20, 0, 40, 0, 40, ['img/sprite_118_0.png']);
}; var sprite_118 = new __sprite_118();

function __sprite_127() { 
__sprite_init__(this, sprite_127, 20, 40, 10, 20, 'Box', 10, 0, 20, 0, 40, ['img/sprite_127_0.png']);
}; var sprite_127 = new __sprite_127();

function __block02() { 
__sprite_init__(this, block02, 80, 80, 40, 40, 'Box', 40, 0, 80, 0, 80, ['img/block02_0.png']);
}; var block02 = new __block02();

function __end() { 
__sprite_init__(this, end, 40, 40, 20, 20, 'Box', 20, 0, 40, 0, 40, ['img/end_0.png']);
}; var end = new __end();

function __load_game() { 
__sprite_init__(this, load_game, 80, 40, 40, 20, 'Box', 40, 0, 80, 0, 40, ['img/load_game_0.png']);
}; var load_game = new __load_game();
...
function __snd_bubuu() { 
__audio_init__(this, snd_bubuu, '', 'aud/クイズ不正解1.mp3', '');
}; var snd_bubuu = new __snd_bubuu();
...
__background_init__(this, background_clouds, 'img/back_2.png')}; var background_clouds = new __background_clouds();
 ...
 ***********************************************************************/
function __font_110() { 
__font_init__(this, font_110, 'Arial', 12, 0, 0)}; var font_110 = new __font_110();
...
with(this) {
this.other = this.place_meeting(this.x, this.y, object_37);
if(this.other != null) {
//player_hp=p;
//p= player_hp;
player_hp += 1;
//if(save_web_data("player_hp")){
//p= player_hp;
//p += 10;
//}

q = (load_web_integer("a,10"))
p= player_hp;
//player_hp = p;
//p += 10;
p += q;
...
this.other = this.place_meeting(this.x, this.y, object_119);
if(this.other != null) {
	//p= player_hp;
	//player_hp = p ;
		//if (room_current == level1)
			//save_web_integer("player_hp", 1);
		//if (room_current == level2)
			//save_web_integer("player_hp", 2);
		//if (room_current == level3)
			//save_web_integer("player_hp", 3);
	//player_hp += 1;
	save_web_integer("strg00",1200);
	//save_web_data("strg00",1000);
...
__instance_init__(this, obj_diamond, null, 1, 0, spr_diamond, 1, 53);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
//obj_diamond speed = 10;
room_speed * 3
...
__instance_init__(this, obj_bullet, null, 1, 0, spr_bullet, 1, 86);
this.on_creation = function() {
with(this) {
...
function __obj_box() {
__instance_init__(this, obj_box, null, 1, 0, spr_box, 1, 87);
this.on_creation = on_creation_i;
...
__instance_init__(this, obj_piece, null, 1, 0, spr_piece, 1, 106);
this.on_creation = function() {
with(this) {
speed = irandom(2) + 2;
...
__instance_init__(this, obj_cloud, null, 1, 100, spr_cloud, 1, 107);
this.on_creation = function() {
with(this) {
speed = 1;
direction = 180;
...
function __object_37() {
__instance_init__(this, object_37, null, 1, -10, sprite_35, 1, 123);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_37 = new __object_37();

function __object_45() {
__instance_init__(this, object_45, null, 1, 0, load_game, 1, 124);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
if(mouse_check_pressed() && position_meeting(mouse_x, mouse_y, object_index)) {
	sound_play(snd_jump);
	player_hp += 50;
	p = player_hp;
	player_hp = p;
	q = load_web_integer("strg00");
...
draw_set_color(255, 240, 0);
draw_set_font(font_110);
draw_set_halign(fa_center);
draw_set_valign(fa_top);
var i = room_width / 2;
draw_text(i,   8, 'This is an example game that');
draw_text(i,  40, 'demonstrates how to use webdata');
draw_text(i,  72, 'to store local highscores');
draw_text(i, 104, '(also some basic text input)');
draw_text(i, 136, 'Click circles before they fade away');
draw_text(i, 168, 'to increase score.');
draw_text(i, y + 40, '^ Click to start ^');
}
}
};
}; var object_45 = new __object_45();

function __object_119() {
__instance_init__(this, object_119, null, 1, 0, sprite_118, 1, 153);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_119 = new __object_119();

function __object_122() {
__instance_init__(this, object_122, null, 1, 0, null, 1, 155);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
if (keyboard_check_released(vk_e) || keyboard_check_released(vk_s) || keyboard_check_released(vk_down)|| instance_number(object_37)) {
//if (instance_number(object_37)) {
	draw_set_color(99,79,57);
	draw_rectangle(room_viewport_x + 16, 16,room_viewport_x + room_viewport_width - 16,48, false);
	draw_set_color(225,186,141);
	draw_rectangle(room_viewport_x + 16, 16,room_viewport_x + room_viewport_width - 16,48,true);
	draw_set_font(font_110);
	draw_set_halign(fa_center);
	draw_set_valign(fa_middle);
	draw_text(room_viewport_x + room_viewport_width/2,32,"Game saved!");
	}
}
}
};
...
function __object_126() {
__instance_init__(this, object_126, null, 1, 0, null, 1, 157);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_126 = new __object_126();

function __object_38() {
__instance_init__(this, object_38, null, 1, -10, sprite_127, 1, 158);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
//if(instance_number(object_38)){
sound_play(snd_diamond);
instance_destroy();
//instance_create(object_38);
new_explosion = instance_create( x, y, object_37 );
}
}
}
};
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_38 = new __object_38();

function __object_136() {
__instance_init__(this, object_136, null, 1, 0, block02, 1, 160);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_136 = new __object_136();

function __HUD() {
__instance_init__(this, HUD, null, 1, 0, null, 1, 164);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
//Aticar costas da HUD
//if(instance_number(obj_tesour)){ 
	//draw_sprite(spr_HUD_esqueleto,spr_HUD_esqueleto,x,y);}
...
//Contrução da HUD
	//Desenha Vida
	draw_text(room_viewport_x + 128, room_viewport_y + 16, "HP: " + player_hp);
	//Desenhar Mana
	draw_text(room_viewport_x + 384,room_viewport_y + 16, "MP: " + mana);
	//Ativar Font da letra
	draw_set_font(font_110);				
...
function __END() {
__instance_init__(this, END, null, 1, 0, end, 1, 167);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
function __new_new() {
__instance_init__(this, new_new, null, 1, 0, new_game, 1, 234);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.objects = [
[{o:obj_ground, x:0, y:440}],
[{o:obj_ground, x:40, y:440}],
[{o:obj_ground, x:40, y:440}],
[{o:obj_ground, x:80, y:440}],
[{o:obj_ground, x:120, y:440}],
[{o:obj_ground, x:600, y:440}],
[{o:obj_ground, x:560, y:440}],
[{o:obj_ground, x:520, y:440}],
[{o:obj_ground, x:480, y:440}],
[{o:obj_ground, x:160, y:440}],
[{o:obj_ground, x:200, y:440}],
[{o:obj_ground, x:240, y:440}],
[{o:obj_ground, x:240, y:400}],
[{o:obj_ground, x:280, y:400}],
[{o:obj_ground, x:280, y:360}],
[{o:obj_ground, x:320, y:400}],
[{o:obj_ground, x:280, y:440}],
[{o:obj_ground, x:320, y:440}],
[{o:obj_ground, x:360, y:440}],
[{o:obj_ground, x:400, y:440}],
[{o:obj_ground, x:440, y:440}],
[{o:obj_ground, x:320, y:360}],
[{o:obj_ground, x:360, y:400}],
[{o:obj_ground, x:280, y:320}],
[{o:obj_ground, x:320, y:320}],
[{o:obj_ground, x:400, y:400}],
[{o:obj_ground, x:440, y:400}],
[{o:object_45, x:240, y:240}],
[{o:object_136, x:80, y:80}],
[{o:object_136, x:400, y:80}],
[{o:object_136, x:240, y:80}],
[{o:HUD, x:240, y:140}],
[{o:new_new, x:240, y:180}]];
this.start = function() {
__room_start__(this, level2, 480, 280, 30, 0, 0, 0, background_clouds.image, 0, 0, 0, 480, 280, obj_player, 50, 50);

	//player_hp += 10;	
	//player_hp = p;
	//q = (load_web_data("player_hp",10))
//save_web_integer("strg00",1000);

	
	
};
}
var level2 = new __level2();
tu_scenes.push(level2);
function __level1() { 
this.tiles = [
];
this.objects = [
...
[{o:obj_ground, x:1580, y:200}],
[{o:obj_ground, x:1560, y:200}],
[{o:obj_ground, x:1580, y:120}],
[{o:obj_ground, x:1580, y:80}],
[{o:obj_ground, x:1580, y:40}],
[{o:obj_ground, x:1580, y:0}],
[{o:obj_ground, x:1560, y:120}],
[{o:obj_ground, x:1560, y:80}],
[{o:obj_ground, x:1560, y:40}],
[{o:obj_ground, x:1560, y:0}],
[{o:obj_player, x:100, y:220}],
[{o:object_119, x:380, y:140}],
[{o:object_122, x:100, y:180}],
[{o:object_38, x:640, y:220}],
[{o:HUD, x:60, y:220}]];
this.start = function() {
__room_start__(this, level1, 1600, 280, 30, 0, 0, 0, background_clouds.image, 1, 0, 0, 480, 280, obj_player, 230, 0);
};
}
...
this.objects = [
[{o:obj_ground, x:0, y:240}],
[{o:obj_ground, x:0, y:200}],
[{o:obj_ground, x:40, y:240}],
[{o:obj_ground, x:80, y:240}],
[{o:obj_ground, x:40, y:200}],
[{o:obj_ground, x:80, y:200}],
[{o:obj_ground, x:160, y:200}],
[{o:obj_ground, x:160, y:240}],
[{o:obj_ground, x:200, y:240}],
[{o:obj_ground, x:200, y:200}],
[{o:obj_ground, x:240, y:200}],
[{o:obj_ground, x:240, y:240}],
[{o:obj_ground, x:360, y:200}],
[{o:obj_ground, x:360, y:240}],
[{o:obj_ground, x:320, y:240}],
[{o:obj_ground, x:400, y:240}],
[{o:obj_ground, x:400, y:200}],
...
[{o:obj_ground, x:1160, y:240}],
[{o:obj_ground, x:1120, y:240}],
[{o:obj_ground, x:1240, y:200}],
[{o:obj_ground, x:1240, y:160}],
[{o:obj_ground, x:1240, y:120}],
[{o:obj_ground, x:1240, y:80}],
[{o:obj_ground, x:1240, y:40}],
[{o:obj_ground, x:1240, y:0}],
[{o:obj_ground, x:1080, y:240}],
[{o:obj_ground, x:480, y:240}],
[{o:obj_ground, x:520, y:240}],
[{o:obj_ground, x:560, y:240}],
...
[{o:obj_ground, x:680, y:240}],
[{o:obj_ground, x:720, y:240}],
[{o:obj_ground, x:480, y:200}],
[{o:obj_ground, x:520, y:200}],
[{o:obj_ground, x:800, y:240}],
[{o:obj_ground, x:880, y:240}],
[{o:obj_ground, x:960, y:240}],
[{o:obj_ground, x:1040, y:240}],
[{o:obj_ground, x:560, y:200}],
[{o:obj_ground, x:600, y:200}],
[{o:obj_ground, x:640, y:200}],
[{o:obj_ground, x:680, y:200}],
[{o:obj_ground, x:720, y:200}],
[{o:obj_ground, x:800, y:200}],
[{o:obj_ground, x:880, y:200}],
[{o:obj_ground, x:960, y:200}],
[{o:obj_ground, x:1040, y:200}],
[{o:obj_ground, x:1080, y:200}],
[{o:obj_ground, x:1120, y:200}],
[{o:obj_ground, x:1160, y:200}],
[{o:obj_ground, x:1200, y:200}],
[{o:END, x:780, y:260}],
[{o:END, x:860, y:260}],
[{o:END, x:940, y:260}],
[{o:END, x:1020, y:260}],
[{o:END, x:300, y:260}],
[{o:obj_ground, x:120, y:200}],
[{o:obj_ground, x:120, y:240}],
[{o:obj_player, x:100, y:180}],
[{o:HUD, x:100, y:140}]];
this.start = function() {
__room_start__(this, level3, 1280, 280, 30, 0, 0, 0, background_clouds.image, 1, 1, 0, 480, 280, obj_player, 50, 50);
};
}
var level3 = new __level3();
tu_scenes.push(level3);
function __level4() { 
this.tiles = [
];
this.objects = [
...
[{o:new_new, x:240, y:180}]];
this.start = function() {
__room_start__(this, level4, 480, 280, 30, 0, 0, 0, background_clouds.image, 0, 0, 0, 480, 280, null, 50, 50);
};
}
var level4 = new __level4();
tu_scenes.push(level4);
tu_room_to_go = level2;
